							...
							<div class="col-lg-5 border-end">
								<div class="card-body">
									<div class="p-5">
										...
										<p class="text-muted text-center">Recibimos su solicitud de restablecimiento de contraseña. ¡Por favor, introduzca su nueva contraseña!</p>
										<div class="mb-3 mt-5">
											<label class="form-label">Nueva Contraseña</label>
											<input type="text" class="form-control" placeholder="Ingresa la Nueva Contraseña" />
										</div>
										<div class="mb-3">
